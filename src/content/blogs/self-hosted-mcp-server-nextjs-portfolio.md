...
readTime: 14
type: technical
excerpt: Most developers use AI as a text generator. I wired Claude directly into my portfolio repo — it can now read, write, and commit any file without me touching a keyboard. This is how the MCP server works, what broke during the build, and why server.close() was the culprit.
