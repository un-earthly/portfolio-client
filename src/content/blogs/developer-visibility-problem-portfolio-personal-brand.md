...
faqs: What's the minimum viable visibility stack for a developer who's starting from zero?::A GitHub profile with documented real projects, one deep public case study with real numbers, and a LinkedIn headline that names a specific outcome rather than a role title. In that order. The case study does the most work — it's searchable, shareable, and self-validating in a way a resume never is. | How do you write a case study that actually converts, not just impresses other developers?::Start with the problem, not the tech. "I built a BLE mesh event platform" is a topic. "I built an event platform that works with no internet for 300 people in a signal-hostile venue" is a story with a client on the other end of it. Every case study should have: the problem, the constraint, your approach, the measurable outcome. | Is content marketing or a case study more important for inbound?::Both, but in the right order. A case study gets you found by people who already have the problem. LinkedIn content builds recall and trust with people who don't have the problem yet but will. The case study is the floor — it has to exist before the content amplification is worth doing.
---
