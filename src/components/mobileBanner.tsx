...
const MobileInto = () => {
    return (
        <div className="w-11/12 mx-auto bg-gradient-to-br from-black/40 to-gray-900/60 border border-cyan-500/20 rounded-xl shadow-lg backdrop-filter backdrop-blur-lg">
            <div className="p-4">
